...
var defaultQuotingParameters : Models.QuotingParameters = new Models.QuotingParameters(0.02, 0.10, 0.05, Models.QuotingMode.Boomerang, Models.FairValueModel.BBO, 1, 0.9, true, Models.AutoPositionMode.EwmaBasic, false, 2, 250, true, .095, 2*.095, .047, 3, .1);
