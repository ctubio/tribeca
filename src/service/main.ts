...
var defaultQuotingParameters : Models.QuotingParameters = new Models.QuotingParameters(0.10, 0.10, 0.05, Models.QuotingMode.Boomerang, Models.FairValueModel.wBBO, 1, 0.9, true, Models.AutoPositionMode.EwmaBasic, false, 4, 250, true, .095, 2*.095, 3*.095, 3, .1);
