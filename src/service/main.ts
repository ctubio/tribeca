...
var defaultQuotingParameters : Models.QuotingParameters = new Models.QuotingParameters(0.30, 0.12, 0.06, Models.QuotingMode.Boomerang, Models.FairValueModel.BBO, 1, 0.9, false, Models.AutoPositionMode.EwmaBasic, false, 6, 120, true, .095, 2*.095, .095, 3, .1);
